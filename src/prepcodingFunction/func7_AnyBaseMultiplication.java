...
public class func7_AnyBaseMultiplication {
    ...
    public static int getProduct(int b , int n1, int n2){
        ...
        while(n2>0){
            ...
            rv = getSum(b , rv , sprd*p); // p align karne keliye hai kyoki 2 digits se jab ham multple karte
            // hai to niche vali digit ak shift hojati hai
            p = p*10;
        }
        return rv;
    }
